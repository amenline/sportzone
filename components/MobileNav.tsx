...
const NavItem: React.FC<Props> = ({ children, link }) => {
  return (
    <li className="p-2 m-1 rounded-md hover:bg-primary-500 hover:text-white text-lg">
      <Link href={`/${link}`}>
        <a>{children}</a>
      </Link>
    </li>
...
const MobileNav: React.FC = () => {
  return (
    <div className="md:hidden fixed top-0 right-0 h-full sm:w-1/2 w-4/6 bg-white shadow-2xl">
      ...
      <ul className="mt-5">
        <NavItem link="news">Home</NavItem>
